...
export const apiSlice = createApi({
  baseQuery,
  tagTypes: ['Product', 'User', 'Order', 'Vendor', 'Settings', 'Review', 'Coupon', 'Wishlist', 'Return', 'Notification', 'Report', 'Subscriber', 'VendorStaff', 'Messages', 'Moderation', 'Commission', 'Campaign', 'Certificate'],
  endpoints: () => ({}),
});
