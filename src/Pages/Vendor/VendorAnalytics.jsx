    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md">
          ...
          <p className="text-3xl font-bold text-green-600">{formatCurrency(avgOrderValue)}</p>
          <p className="text-sm text-gray-500 mt-2">Per transaction</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md">
          <h3 className="text-sm text-gray-600 dark:text-gray-400 mb-2">Total Earned</h3>
          <p className="text-3xl font-bold text-amber-600">{formatCurrency(wallet?.total_earned || 0)}</p>
              ...
              <tbody>
                {topProducts.map((p, i) => (
                  <tr key={i} className="border-b border-gray-100 dark:border-gray-700 last:border-0">
                    ...
                    <td className="py-3 font-semibold text-primary">{formatCurrency(p.revenue)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
