...
const VendorDirectory = () => {
  const { data: vendors = [], isLoading, isError } = useGetVendorDirectoryQuery();
              ...
              >
                ...
                <div className="p-5 pt-8">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-3">
                    {v.verificationLevel && levelMeta[v.verificationLevel] ? (
                      <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${levelMeta[v.verificationLevel].cls}`}>
                        <FaAward /> {levelMeta[v.verificationLevel].label}
                      </span>
                    ) : null}
