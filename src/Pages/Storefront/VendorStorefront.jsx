...
const VendorStorefront = () => {
  ...
  const { vendor, products = [], rating, reviewCount, productCount } = data;
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  {vendor.verificationLevel && levelMeta[vendor.verificationLevel] && (
                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${levelMeta[vendor.verificationLevel].cls}`}>
                      <FaAward /> {levelMeta[vendor.verificationLevel].label}
                    </span>
                  )}
                  {(vendor.badges || []).map((b) => (
