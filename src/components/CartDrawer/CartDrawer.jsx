              ...
              >
                <div className="flex gap-3">
                  <img
                    ...
                    onError={(e) => { e.target.onerror = null; e.target.src = 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><rect fill="#f4eee1" width="100" height="100"/><text x="50" y="55" font-family="sans-serif" font-size="12" fill="#8a6d3b" text-anchor="middle">Kente</text></svg>'); }}
                  />
                  <div>
